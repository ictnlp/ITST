# Read/Write policy of ITST with fixed pre-decision
#
# by Shaolei Zhang
...
class FairseqSimulSTAgent(SpeechAgent):
    ...
    def add_args(parser):
        ...
        parser.add_argument("--test-threshold", type=float, default=10000,
    ...
    def load_model_vocab(self, args):
        ...
        arg_overrides = {"test_threshold": args.test_threshold}
