...
@register_model("transformer_itst")
class ITSTTransformerModel(FairseqEncoderDecoderModel):
    """
    ...
    def build_encoder(cls, args, src_dict, embed_tokens):
        return ITSTTransformerEncoder(args, src_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        return ITSTTransformerDecoder(
            args,
            tgt_dict,
            embed_tokens,
...
class ITSTTransformerEncoder(FairseqEncoder):
    """
    ...
    def forward_scriptable(
        ...
        for layer in self.layers:
            x = layer(
                ...
                attn_mask=self.buffered_future_mask(x) if self.uni_encoder else None,
            )
            if return_all_hiddens:
...
@register_model_architecture("transformer_itst", "transformer_itst")
