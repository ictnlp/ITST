...
class FairseqTask(object):
    ...
    def build_generator(
        ...
        from fairseq.itst_sequence_generator import ITSTSequenceGenerator
        ...
        if seq_gen_cls is None:
            ...
            elif getattr(args, "waitk_decoding", False):
                seq_gen_cls = WaitkSequenceGenerator
                extra_gen_cls_kwargs["waitk_test_lagging"] = args.waitk_test_lagging
                extra_gen_cls_kwargs["fixed_segment"] = args.fixed_segment
            elif getattr(args, "itst_decoding", False):
                seq_gen_cls = ITSTSequenceGenerator
                extra_gen_cls_kwargs["test_threshold"] = args.itst_test_threshold
            else:
