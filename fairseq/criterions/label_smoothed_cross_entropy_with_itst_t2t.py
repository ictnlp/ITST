...
@register_criterion("label_smoothed_cross_entropy_with_itst_t2t")
class LabelSmoothedCrossEntropyCriterionWithITSTT2T(FairseqCriterion):
    def __init__(
        self,
        task,
        sentence_avg,
    ...
    def forward(self, model, sample, update_num=None, reduce=True):
        ...
        info_loss = (
            ...
            * bulid_weight_matrix_t2t(info_transport.size(-1), info_transport.size(-2))
